...
# cd /etc/config && wget -O autoupdate.sh https://github.com/lylus/OpenWrt-Firmware-Lean/raw/main/autoupdate.sh && chmod 700 /etc/config/autoupdate.sh && /etc/config/autoupdate.sh
...
# 获取固件最新版本号
	...
	api_url="https://api.github.com/repos/lylus/OpenWrt-Firmware-Lean/releases/latest"
...
EOF
	...
	releases_url=https://github.com/lylus/OpenWrt-Firmware-Lean/releases/download/${new_ver}/openwrt-x86-64-generic-squashfs-combined-efi.img.gz
	sha256sums_url=https://github.com/lylus/OpenWrt-Firmware-Lean/releases/download/${new_ver}/sha256sums
